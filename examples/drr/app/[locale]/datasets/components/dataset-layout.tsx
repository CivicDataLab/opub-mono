...
import { IconButton, Text, TextField } from 'opub-ui'
...
export function Content({ count, data, filters }: { count: number; data: Datasets[]; filters: FilterProps[] }) {
				...
				<div className='mt-2 mb-6 flex gap-8 bg-surfaceHighlightSubdued border-b-1 items-center pt-3 pb-4 pl-8 pr-8'>
					...
					<div className='w-7/12 flex gap-2 items-center'>
						<div className='flex-1'>
							<TextField placeholder='Search' name='Search' label='Search' type='search' labelHidden />
						</div>
						<IconButton
