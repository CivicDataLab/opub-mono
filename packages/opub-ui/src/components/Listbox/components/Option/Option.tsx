...
import { ActionContext, useListbox } from '../../utils';
import { UnstyledLink } from '@ui/components/Link/BaseLink';
import { MappedActionContext } from '@ui/components/Autocomplete/utils';
...
export const Option = memo(function Option({
  ...
  return (
    <li
      ...
      className={cx(styles.Option, divider && styles.divider)}
      id={domId}
      ref={listItemRef}
      tabIndex={-1}
