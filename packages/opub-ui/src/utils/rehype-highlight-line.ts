...
const wrapLines = function wrapLines(ast: any, linesToHighlight: any) {
  const highlightAll =
...
const applyMultilineFix = function (ast: any) {
  ...
  // Fix JSX issue
  html = html.replace(MULTILINE_TOKEN_SPAN, (match: any, token: any) =>
...
export const highlightLineCode = function (ast: any, lines: any) {
